        ...
        <main className="p-4 max-w-7xl mx-auto">
          ...
          <div className="bg-bg2-light dark:bg-bg2-dark rounded-lg p-6 border border-black/8 dark:border-white/10">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>⏳ Components being migrated...</li>
            </ul>
          </div>
        </main>

        <footer className="p-4 text-center text-sm text-muted-light dark:text-muted-dark border-t border-black/8 dark:border-white/10">
